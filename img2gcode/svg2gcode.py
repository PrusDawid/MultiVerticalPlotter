...
# Local Imports
sys.path.insert(0, './svg_lib') # (Import from lib folder)
import shapes 
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Convert vectorized line drawing to gCode file.')
    parser.add_argument('-i','--input',dest='input_path',
        action='store',nargs='?',type=str,
        help='Input path')
    args = parser.parse_args()
    generate_gcode(args.input_path)
